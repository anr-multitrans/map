...
class TestAllMaps(unittest.TestCase):
    ...
    def setUp(self):
        ...
        for map_name in locations:
            ...
            nusc_map = NuScenesMap(map_name=map_name, dataroot='/home/li/Documents/NuScenes/data/sets/nuscenes')
    ...
    def test_egoposes_on_map(self):
        ...
        nusc = NuScenes(version=self.version, dataroot='/home/li/Documents/NuScenes/data/sets/nuscenes', verbose=False)
