...
from eval.common.utils import quaternion_yaw, Quaternion
# from nuscenes.map_expansion.map_api import NuScenesMap, NuScenesMapExplorer
from MapTR.projects.mmdet3d_plugin.datasets.nuscenes_dataset import CustomNuScenesDataset
...
class CustomNuScenesOfflineLocalMapDataset(CustomNuScenesDataset):
    ...
    def _evaluate_single(self,
        ...
        """
        from MapTR.projects.mmdet3d_plugin.datasets.map_utils.mean_ap import eval_map
        from MapTR.projects.mmdet3d_plugin.datasets.map_utils.mean_ap import format_res_gt_by_classes
