...
class MapTransform:
    ...
    def patch_box_2_coords(self, box):
        ...
        coors = (box[0] - box[3]/2, box[1] - box[2]/2, box[0] + box[3]/2, box[1] + box[2]/2)
    ...
    def add_ped_crossing_layer(self, patch_box, patch_angle, road_segment_token = None): 
    ...
    def delte_layers(self, patch_box, patch_angle, layers = ['ped_crossing'], token = None): #TODO: for layer_name, token in trans_args[(),()]
        # patch_box = self.patch_coords_2_box(patch_coords)
        patch_coords = self.patch_box_2_coords(patch_box)
        polygon_list = []
...
if __name__ == '__main__':
    ...
    new_polygon_list_shi = map_trans.transfor_layer(patch_box, patch_angle, 'ped_crossing', ped_cro_token, shift = [4, 0])
    
    # delet a ped_crossing
    new_polygon_list_del = map_trans.delte_layers(patch_box, patch_angle, ['ped_crossing'], ped_cro_token)
    ...
    new_polygon_list_add = map_trans.add_ped_crossing_layer(patch_box, patch_angle, roa_seg_token)
